...
public class Tree {
	...
	public static void main(String[] args) {
        ...
        contact a1=new contact(a,"Bhargav","Bhargav@gmail.com",Gender.male);
        contact a2=new contact(b,"Lakshmi","Lakshmi@gmail.com",Gender.female);
        contact a3=new contact(c,"Sairam","Sairam@gmail.com",Gender.male);
        contact a4=new contact(d,"Asiya","Asiya@gmail.com",Gender.male);
