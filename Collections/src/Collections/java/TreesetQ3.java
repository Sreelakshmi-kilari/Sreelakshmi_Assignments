...
import java.util.*;
	...
	public class TreesetQ3 {
	    ...
	    public static void main(String[] args) {
	        ...
	        s.add(new Employees ("Nandu",123,50000,"Dev"));
	        s.add(new Employees ("Mahi",456,60000,"HR"));
	        s.add(new Employees ("Ayusha",789,30000,"Mgmt"));
	        s.add(new Employees("Ramya",111,90000,"Mgmt"));
	        s.add(new Employees("Manasa",222,10000,"Dev"));
